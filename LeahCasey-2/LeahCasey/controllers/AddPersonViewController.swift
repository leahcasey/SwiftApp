...
class AddPersonViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    var pManagedObject : CDPerson! = nil
    ...
    func save(){
        ...
        pEntity = NSEntityDescription.entity(forEntityName: "CDPerson", in: context)
        pManagedObject = CDPerson(entity: pEntity, insertInto: context)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "addSegue2" {
            let destinationController = segue.destination as! PeopleTableViewController
